...
export default function QuickEvaluationPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #e0f2fe 0%, #f0fdf4 100%)' }}>
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-700 to-blue-900 dark:from-gray-800 dark:to-gray-900 border-b border-blue-800 dark:border-gray-700 sticky top-0 z-50" style={{ padding: '0.75rem 0' }}>
